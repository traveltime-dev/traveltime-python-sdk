...
from traveltimepy.dto.common import (
    Location, Rectangle, CellProperty, Coordinates, )
from traveltimepy.dto.requests.distance_map import DistanceMapDepartureSearch, DistanceMapArrivalSearch, \
    DistanceMapUnion, DistanceMapIntersection, DistanceMapRequest
...
from traveltimepy.dto.requests.geohash import GeoHashDepartureSearch, GeoHashArrivalSearch, GeoHashUnion, \
    GeoHashIntersection, GeoHashRequest
from traveltimepy.dto.requests.geohash_fast import GeoHashFastArrivalSearches, GeoHashFastRequest
from traveltimepy.dto.requests.h3 import H3DepartureSearch, H3ArrivalSearch, H3Union, H3Intersection, H3Request
from traveltimepy.dto.requests.h3_fast import H3FastRequest, H3FastArrivalSearches
from traveltimepy.dto.requests.postcodes import PostcodesRequest, PostcodeArrivalSearch, PostcodeDepartureSearch
from traveltimepy.dto.requests.postcodes_zones import PostcodesDistrictsRequest, PostcodeFilterArrivalSearch, \
    PostcodeFilterDepartureSearch, PostcodesSectorsRequest
from traveltimepy.dto.requests.routes import RoutesArrivalSearch, RoutesDepartureSearch, RoutesRequest
...
from traveltimepy.dto.requests.time_filter_fast import TimeFilterFastArrivalSearches, TimeFilterFastRequest
from traveltimepy.dto.requests.time_filter_proto import TimeFilterFastProtoRequest, TimeFilterFastProtoTransportation, \
    RequestType, ProtoCountry
...
class AsyncClient(AsyncBaseClient):
    ...
    async def time_filter_fast(
        ...
        resp = await self._api_call_post(
            ...
            "time-filter/fast",
            AcceptType.JSON,
            TimeFilterFastRequest(locations=locations, arrival_searches=arrival_searches)
        )
        return resp.results
